...
export function PrivacyPolicyPage() {
  return (
    <LegalLayout title="Privacy Policy" effectiveDate="March 8, 2026">
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">9. Data Portability</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">10. Account Deletion</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">11. Your Rights Under GDPR</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            ...
            format as described in Section 9.
          </li>
          <li>
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">12. Your Rights Under CCPA</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            ...
            You can also self-serve this through account deletion (Section 10).
          </li>
          <li>
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">13. Data Breach Notification</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">14. Children's Privacy</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-xl font-semibold mt-8 mb-4">15. Changes to This Policy</h2>
        <p className="mb-4">
